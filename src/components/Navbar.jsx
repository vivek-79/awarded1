        ...
        <header className='absolute  top-1/2 w-full -translate-y-1/2'>
            <nav className='flex size-full items-center justify-between p-4'>
                <div className='flex items-center gap-7'>
                    ...
                    className='w-10'
                    />
                    <Button id='product-button' title='Products' rightIcon={<TiLocationArrow/>} containerClas="bg-blue-50 md:flex items-center justify-center gap-1 max-md:!py-1"/>
                </div>
                ...
                <div className='flex h-full items-center'>
                    ...
                    <button onClick={toggleAudioIndicator} className='ml-10 flex items-center space-x-0.5'>
                        <audio ref={audioElementRef} className='hiden ' src='/audio/loop.mp3' loop/>
                        {[1,2,3,4].map((bar)=>(
