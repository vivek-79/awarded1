...
function Hero() {
    ...
    const [hasClicked,setHasClickec] = useState(false);
        ...
        rounded-lg bg-blue-75'>
            ...
            <div className='absolute left-0 top-0 z-40 size-full'>
                <div className='mt-24 px-5 sm:px-10'>
                    ...
                    <Button id='watch-trailer' title='Watch Trailer' leftIcon={<TiLocationArrow />} containerClas='!bg-yellow-300 flex-center gap-1'/>
                </div>
            </div>
        </div>
