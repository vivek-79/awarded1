...
function Story() {
  ...
  return (
    <section id='story' className='min-h-dvh w-screen bg-black text-blue-50'>
      <div className='flex flex-col items-center size-full pb-24'>
        <p className='font-general text-sm md:text-[10px]'>the multiversal ip world</p>
        <div className='relative size-full'>
            <AnimatedTitle title='The st<b>o</b>ry of<br/> a hidden real<b>m</b>'
            sectionId='#story'
            containerClas='mt-5 pointer-events-none mix-blend-difference relative z-10'
            />
        ...
        <div className='-mt-80 flex w-full justify-center md:-mt-64 md:me-44 md:justify-end'>
          <div className='flex h-full w-fit flex-col items-center md:items-start'>
            ...
            <Button id='realm-button' title='discover prologue' containerClas='mt-5'/>
          </div>
        </div>
      </div>
    </section>
